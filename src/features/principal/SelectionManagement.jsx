...
import { fetchAds } from '../admin/advertisementSlice';
import { 
...
const SelectionManagement = () => {
  ...
  useEffect(() => {
    dispatch(fetchAds({ institution_id: institutionId, status: 'PUBLISHED' }));
    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-700 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 px-4 py-2 bg-emerald-50 border border-emerald-100 rounded-2xl">
          ...
          <span className="text-xs font-black text-emerald-700 uppercase tracking-wider">Principal Panel</span>
        </div>
      </div>
      ...
      <div className="bg-white border border-slate-200 rounded-[2.5rem] shadow-sm overflow-hidden min-h-[500px]">
        ...
        {activeStep === 0 && (
          <div className="p-12 flex flex-col items-center text-center max-w-2xl mx-auto">
            ...
            <h2 className="text-2xl font-black text-slate-900 mb-2">Select Advertisement</h2>
            ...
            <div className="w-full space-y-4">
              {ads.length === 0 ? (
                ...
                ads.map(ad => (
                  ...
                  >
                    <div>
                      <div className="text-sm font-black text-slate-900 group-hover:text-indigo-600">AD #{ad.id.slice(0,8)}</div>
                      <div className="text-xs text-slate-500 font-medium">{ad.course_name} • {ad.vacancy_count} Vacancies</div>
                    </div>
